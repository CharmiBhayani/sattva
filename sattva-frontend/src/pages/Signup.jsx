      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-sattvaBeige/50">
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-serif text-sattvaDark mb-2">Create Account</h2>
            <p className="text-sm text-sattvaBrown/70 font-light">Begin your wellness journey</p>
          </div>
