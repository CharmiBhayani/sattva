...
🧘 Hybrid Learning Model (Free + Paid)
    ...
    Admin-curated yoga poses with real goals (e.g., flexibility, stress relief, back pain)
...
This dual model allows users to:
Start free → progress to professional guidance when ready.
...
💳 Payment Flow (Mock Implementation)
    Session booking creates paymentStatus = pending
    Mock payment API updates status to paid
    Paid sessions appear in My Bookings
    Designed to be easily replaceable with Razorpay/Stripe
...
🌟 Unique Value Proposition
    ...
    This makes Sattva both an educational tool and a tutor marketplace.
